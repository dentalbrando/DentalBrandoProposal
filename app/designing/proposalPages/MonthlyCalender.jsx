        ...
        <div className="flex justify-between items-start w-[100%] h-[50%] bg-purple-20">
          <div>
            ...
            <p className="w-[92%] text-justify">
              ...
              platforms like Facebook, Instagram, LinkedIn, Twitter, Pinterest,
              and any other platform if you want it. We will then optimize your
              whole profile to align with your unique business goals to create a
              strong brand identity online. We complete the optimization process
              with a concise bio having relevant keywords, branded images, and
              compelling content to improve your business visibility on social
              media.
            </p>
          </div>
