    ...
    <div className="flex flex-col justify-center items-center h-[100%] bg-red-20 relative">
      ...
      <div className="w-[87%] h-[75%] bg-red-70">
        <div className="flex flex-col justify-center w-full leading-none">
          ...
          <span className="text-[#00A2FF] text-[44px] font-[600]">Letter</span>
          <div className="w-[100px] h-[5px] bg-yellow-400 my-3"></div>
        </div>
        <div className="flex flex-col justify-center w-full text-justify">
          <span className="text-[24px] font-[700] underline">Dear Client</span>
          <p className="text-[15px] font-[400] mt-1 leading-normal">
            ...
            busy making businesses successful through Social Media Marketing. We
            are confident that we can take your online presence and brand
            visibility to an elevated level with our esteemed Social Media
            Marketing services.
          </p>
          <p className="text-[15px] font-[400] mt-5 leading-normal">
            Soft Enterprise specializes in creating customized Social Media
            strategies tailored to the unique needs of our clients. Social Media
            acts as a bridge, not only among friends and family but also between
            businesses and their target. As the social network grew from its
            emergence, so did the idea to use divergent platforms as a means of
            advertising and reaching out to different cohorts of target
            audiences. We leverage Social Media to market the products and
            services of our clients in their niche by micro-targeting audiences
            with our expertise.
          </p>
          <p className="text-[15px] font-[400] mt-5 leading-normal">
            ...
            identity, and how they provide value to your target audience. We do
            your complete brand reputation management to make your brand image
            consistent across all your social media platforms. We will update
            you on our Social Media Marketing efforts with clear and detailed
            performance reports from advanced analytical tools indicating Key
          ...
          <p className="text-[15px] font-[400] mt-5 leading-normal">
            ...
            Marketing needs. We are excited at the prospect of working with you
            and creating a cohesive social media brand presence for your
      ...
      <div className="absolute bottom-0 h-[100px] w-[100%] overflow-hidden">
        <div className="flex justify-between items-center w-full px-16 h-full absolute top-[15%] left-0 z-[50]">
          ...
          <span className="text-gray-700 text-[15px] font-[500]">Page 01</span>
        </div>
