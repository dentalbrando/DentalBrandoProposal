            ...
            <div className="absolute w-[87%] h-[50%] right-[6.5%] top-[120px] z-[200] ">
              ...
              <div className="flex flex-col justify-center w-full leading-snug">
                <span className="text-[white] text-[15px] font-[400]">
                  ...
                  industries. Whatever industry you are coming from, we
                  understand your unique needs with our commitment to excellence
                  and innovation. Join our growing list of satisfied clients to
              ...
              <div className="w-[60%] h-[100%] flex justify-center items-center bg-yellow-5">
                <div className="w-[100%] h-fit leading-tight text-justify">
                  ...
                  <span className="text-[16px] font-[400]">
                    ...
                    Marketing services have helped us achieve remarkable
                    campaign results. We look forward to excelling in our
                    projects!
                  </span>
                </div>
              </div>
