          ...
          <div className="absolute w-[87%] right-[6.5%] top-[120px] z-[200]">
            ...
            <div className="flex flex-col justify-center w-full leading-snug">
              <span className="text-[white] text-[15px] font-[400]">
                ...
                residential apartments. We believe that powerful content
                creation is the backbone of marketing success, so we will create
                engaging content that showcases the luxury mall, amenities, and
                lifestyle offered by you.
              </span>
            </div>
          </div>
