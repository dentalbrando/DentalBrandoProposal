      ...
      <div className="flex flex-col justify-center items-center h-[100%] relative">
        <div className="flex w-full h-[40%] absolute top-0 overflow-hidden">
          <div className="w-[200%] h-[300%] rounded-[40%] absolute bottom-[0%] right-[20%] z-[50] bg-[#00A2FF]">
            <div className="flex flex-col justify-between absolute left-[62%] bottom-[0%] w-[430px] h-[420px] z-[100]">
              <div className="h-[20%]">
                <img src={WhiteLogo1.src} className="w-[95px]" />
              </div>
              <div className="flex flex-col justify-start w-[100%] h-[75%] leading-[60px]">
