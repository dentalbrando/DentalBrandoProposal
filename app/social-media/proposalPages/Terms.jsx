      ...
      <div className="w-[87%] h-[59%] z-[100] absolute bottom-[9%] flex flex-wrap justify-between gap-[1.5%]">
          ...
          <div className=" w-[100%] h-[50%] right-[6.5%] top-[25%] z-[200] bg-red-90">
            ...
            <div className="w-full flex justify-end leading-[1.3]">
              <span className="text-[15px] font-[400] text-justify w-[87%]">
                ...
                work but will not be held responsible for any damages resulting
                from their to the social media account’s usage. After the
                project handover, the client will be solely responsible for
                changing their all user credentials and managing the user’s
                access to their social media account dashboard.
              </span>
            </div>
          </div>
          <div className="bg-[#FFD600] w-[2px] h-[70%] absolute top-[22%] left-[7%]"></div>
        ...
        <div className="w-[49%] h-[32%] leading-none relative">
          <div className=" w-[100%] h-[50%] right-[6.5%] top-[25%] z-[200] bg-red-90">
            ...
            <div className="w-full flex justify-end leading-[1.3]">
              <span className="text-[15px] font-[400] text-justify w-[87%]">
                Any additional work or services requested by the client that are
                outside the scope of the original project agreement may incur
                additional charges. These additional charges will be
                communicated to the client and must be agreed upon in written.
          ...
          <div className=" w-[100%] h-[50%] right-[6.5%] top-[25%] z-[200] bg-red-90">
            ...
            <div className="w-full flex justify-end leading-[1.3]">
              <span className="text-[15px] font-[400] text-justify w-[87%]">
                ...
                critical to our clients' success. We value your privacy and your
                rights. We will not disclose any confidential information to a
                third party provided by you during the project without your
          ...
          <div className=" w-[100%] h-[50%] right-[6.5%] top-[25%] z-[200] bg-red-90">
            ...
            <div className="w-full flex justify-end leading-[1.3]">
              <span className="text-[15px] font-[400] text-justify w-[87%]">
                ...
                transferred to you. Until then, all materials, including design
                concepts, drafts, and prototypes, are the property of Soft
                Enterprise. If it goes to default, Soft Enterprise can utilize
                it for any other projects, or any other clients.
              </span>
            </div>
          </div>
          <div className="bg-[#FFD600] w-[2px] h-[70%] absolute top-[22%] left-[7%]"></div>
        ...
        <div className="w-[49%] h-[32%] leading-none relative">
          <div className=" w-[100%] h-[50%] right-[6.5%] top-[25%] z-[200] bg-red-90">
            ...
            <div className="w-full flex justify-end leading-[1.3]">
              <span className="text-[15px] font-[400] text-justify w-[87%]">
                In the proposal, we will include an estimated project timeline,
                and we will do our best to complete the project within that time
                frame. Although unexpected events can cause delays, such as
                changes in project scope, payment delays, and external factors,
                we will inform you promptly about any modifications to the
                schedule.
              </span>
            </div>
          </div>
