...
const Popup = ({ message = "Nothing found", type, onHide, flex = false }) => {
    ...
    return (
        <div className={`fixed top-2 ${flex ? "flex" : ""}right-3 w-fit ${alertClassName} rounded-lg  text-white p-5 text-center z-[1000]`}>
            {message}
