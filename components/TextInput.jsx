...
const TextInput = (props) => {
    ...
    return (
        <div className={`flex flex-col flex-1 ${props.customClass}'`}>
            {!props.noLabel && <label className='text-gray-900 3xl:text-2xl text-lg my-2'>
                {props.label}
            ...
            <input
                ...
                className={`text-gray-900 3xl:text-2xl text-lg p-2 ${props.border} rounded-md font-normal outline-none`}
