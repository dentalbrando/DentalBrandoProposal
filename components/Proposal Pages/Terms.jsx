                ...
                <div>
                  ...
                  <div className=" w-full mx-auto pb font-[400] text-[13px] text-justify pt-1 ">
                    <p>
                      ...
                      installment is due after half of the work done and remaining
                      50% is due upon full completion. The two remaining $129.99/Month each.{" "}
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  <div className=" w-full mx-auto pb font-[400] text-[13px] text-justify pt-1 ">
                    <div className=" w-full mx-auto pb font-[400] text-[13px] text-justify ">
                      <p>
                        ...
                        your website. Once you pay full payment, you own the website.{" "}
                      </p>
                    </div>
                  </div>
                </div>
