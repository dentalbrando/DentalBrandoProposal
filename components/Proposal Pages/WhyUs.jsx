        ...
        <>
                ...
                <div class="flex w-full ">
                        ...
                        <div class="w-[90%]  mx-auto">
                            ...
                            <div class="mt-[25px] ">
                                <h1 class="font-[700]  text-[25pt] text-[#00A2FF] leading-10" style={{ fontFamily: "'Montserrat', sans-serif" }}>WHY <br />SOFT ENTERPRISE </h1>
                            ...
                            <div class="   mt-2 font-[400] text-[10pt] tracking-[-0.50pt]">
                                <div class="Part-one mr-4    ">
                                    <p>
                                        Choosing the right web development company is crucial for a company's success. Soft
                                        Enterprise has a proven track
                                        record of delivering high quality websites and web applications. We believe that Soft
                                        Enterprise can be a valuable partner
                                        for your business looking to create or improve your online presence. We are excited to
                            ...
                            <div class="flex   mt-10 border border-[#00A2FF]  w-[100%] h-[9%] mx-auto relative">
                                ...
                                <div class="w-fit h-fit flex items-center justify-center">
                                    <img src={svg9.src} alt="Top Left Image"
                                ...
                                <div class="flex  justify-center">
                                    <p class=" w-[93%]   text-[10pt] font-[400] text-justify  mt-[25px] tracking-[-0.5pt]">
                                        We have a team of experienced web developers who specialize in designing and building
                                        high-quality websites and web applications. Our team has the expertise to handle all
                                        aspects
                                        of the web development process, from planning and design to development and maintenance
                                    </p>
                                </div>

                                <div class=" w-fit flex items-center justify-center self-end ">
                                    <img src={svg9.src} alt="Bottom Right Image" class="bottom-0 right-0 w-[200px] " />
                                    <img class="absolute w-12" src={svg1.src} alt="" />
                                </div>

                                <div class="absolute w-fit flex items-center justify-center top-[-18px] left-[80px]">
                                    <img src={svg7.src} alt="Top Left Image" class="  h-[40px]  w-[230px] " />
                                    <p class="absolute text-black font-[600] text-[13pt] ">Expertise</p>
                                </div>
                            ...
                            <div class="flex   mt-6 border border-[#ffd600]  w-[100%] h-[9%] mx-auto relative">
                                ...
                                <div class="w-fit h-fit flex items-center justify-center">
                                    <img src={svg10.src} alt="Top Left Image"
                                ...
                                <div class="flex  justify-center">
                                    <p class=" w-[93%]   text-[10pt] font-[400] text-justify  mt-[25px] tracking-[-0.5pt]">
                                        We are committed to delivering high-quality, responsive, and optimized websites that
                                        meet
                                        the needs of our clients. We use the latest web development technologies and best
                                        practices
                                        to ensure that our projects are both functional and visually appealing.
                                    </p>
                                </div>

                                <div class=" w-fit flex items-center justify-center self-end ">
                                <img src={svg10.src} alt="Bottom Right Image" class="bottom-0 right-0 w-[192px] " />
                                    <img class="absolute w-12" src={svg2.src} alt="" />
                                </div>

                                <div class="absolute w-fit flex items-center justify-center top-[-18px] left-[80px]">
                                    <img src={svg8.src} alt="Top Left Image" class="  h-[40px]  w-[230px] " />
                                    <p class="absolute text-black font-[600] text-[13pt] "> Quality</p>
                                </div>
                            ...
                            <div class="flex   mt-6 border border-[#00A2FF]  w-[100%] h-[9%] mx-auto relative">
                                ...
                                <div class="flex  justify-center">
                                    <p class=" w-[93%]   text-[10pt] font-[400] text-justify  mt-[25px] tracking-[-0.5pt]">
                                        We pride ourselves on providing excellent customer service to our clients. We work
                                        closely
                                        with our clients throughout the web development process to ensure that we understand
                                        their
                                        needs and can deliver the results they want. Our support team is always available for
                                        you.
                                ...
                                <div class="absolute w-fit flex items-center justify-center top-[-18px] left-[80px]">
                                    <img src={svg7.src} alt="Top Left Image" class="  h-[40px]  w-[230px] " />
                                    <p class="absolute text-black font-[600] text-[13pt] ">Customer Satisfaction</p>
                                </div>
                            ...
                            <div class="flex   mt-6 border border-[#ffd600]  w-[100%] h-[9%] mx-auto relative">
                                ...
                                <div class="flex  justify-center">
                                    <p class=" w-[93%]   text-[10pt] font-[400] text-justify  mt-[25px] tracking-[-0.5pt]">
                                        We offer competitive pricing for our web development services without compromising on
                                        quality.
                                ...
                                <div class=" w-fit flex items-center justify-center self-end ">
                                    <img src={svg10.src} alt="Bottom Right Image" class="bottom-0 right-0 w-[200px] " />
                                    <img class="absolute w-10" src={svg4.src} alt="" />
                                </div>

                                <div class="absolute w-fit flex items-center justify-center top-[-18px] left-[80px]">
                                    <img src={svg8.src} alt="Top Left Image" class="  h-[40px]  w-[230px] " />
                                    <p class="absolute text-black font-[600] text-[13pt] "> Competitive Pricing</p>
                                </div>
                            ...
                            <div class="flex   mt-6 border border-[#00A2FF]  w-[100%] h-[9%] mx-auto relative">
                                ...
                                <div class="flex  justify-center">
                                    <p class=" w-[93%]   text-[10pt] font-[400] text-justify  mt-[25px] tracking-[-0.5pt]">
                                        We understand that time is of the essence in business, which is why we strive to deliver
                                        our
                                        web development projects on time, every time. We work diligently to ensure that all
                                        projects
                                        are completed within the agreed-upon timeframe and you will get your work done on time.
                                    </p>
                                </div>
                                ...
                                <div class="absolute w-fit flex items-center justify-center top-[-18px] left-[80px]">
                                    <img src={svg7.src} alt="Top Left Image" class="  h-[40px]  w-[230px] " />
                                    <p class="absolute text-black font-[600] text-[13pt] ">Timely Delivery
                                    </p>
                                </div>
                            ...
                            <div class="flex   mt-6 border border-[#ffd600]  w-[100%] h-[9%] mx-auto relative">
                                ...
                                <div class="flex  justify-center">
                                    <p class=" w-[93%]   text-[10pt] font-[400] text-justify  mt-[25px] tracking-[-0.5pt]">
                                        We provide ongoing support and maintenance services to ensure that your website
                                        remains up-to-date and secure. We are always available to answer any questions or
                                        concerns you may have and provide timely support when you need it.
                                    </p>
                                </div>

                                <div class=" w-fit flex items-center justify-center self-end ">
                                <img src={svg10.src} alt="Bottom Right Image" class="bottom-0 right-0 w-[177px] " />
                                    <img class="absolute w-10" src={svg6.src} alt="" />
                                </div>

                                <div class="absolute w-fit flex items-center justify-center top-[-18px] left-[80px]">
                                    <img src={svg8.src} alt="Top Left Image" class="  h-[40px]  w-[230px] " />
                                    <p class="absolute text-black font-[600] text-[13pt] "> Ongoing Support</p>
                                </div>
